...
simulate_rf_setting_2 <- function(data, n_test, n_val, p, p_eff, beta_eff, eps, num.trees, mtry, min_node_size, ...){
  ...
  ## Return 
  return(list(test_dat, rf, params, val_dat, effect_var_ids, noise_var_ids, train_dat, "y"))
}